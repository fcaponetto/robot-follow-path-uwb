...
const byte chan_idxnb[8] = {0, 0, 1, 2, 0, 3, 0, 0}; //only channels 1,2,3 and 5 are in the narrow band tables
const byte chan_idxwb[8] = {0, 0, 0, 0, 0, 0, 0, 1}; //only channels 4 and 7 are in in the wide band tables
...
const byte range25cm16PRFnb[4][NUM_16M_OFFSET] =
{
...
const byte range25cm16PRFwb[2][NUM_16M_OFFSETWB] =
{
...
const byte range25cm64PRFnb[4][NUM_64M_OFFSET] =
{
...
const byte range25cm64PRFwb[2][NUM_64M_OFFSETWB] =
{
 ...
 */
double dwm_getrangebias(byte chan, float range, byte prf)
{
